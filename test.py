...
shutil.rmtree(os.path.join("tmpfs","test_dir"))
...
model_dir = os.path.join("tmpfs","model")
...
pre_model_dir = os.path.join("kaldi_models","ivector_models")
...
'''
group_id = os.path.join("tmpfs","test_dir","test-iv-OSI")
...
'''
group_id = os.path.join("tmpfs","test_dir","test-gmm-OSI")
...
'''
group_id = os.path.join("tmpfs","test_dir","test-iv-CSI")
iv_csi_model = iv_CSI(group_id, iv_model_list)
spk_ids = np.array(iv_csi_model.spk_ids)
print('spk_ids in iv_csi_model:', spk_ids)
...
''' 
group_id = os.path.join("tmpfs","test_dir","test-gmm-CSI")
...
for model in iv_model_list:
    spk_id = model[0]
    spk_id_extra = os.path.join("tmpfs","test_dir","test-iv-SV-"+spk_id)
...
for model in gmm_model_list:
    spk_id = model[0]
    spk_id_extra = os.path.join("tmpfs","test_dir","test-gmm-SV-"+spk_id)
